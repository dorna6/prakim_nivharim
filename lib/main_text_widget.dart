    ...
    return Column(children: [
      ...
      CustomRichTextPasok(
        ...
        textSpan: TextSpan(
          children: <TextSpan>[
            TextSpan(
              text: "לַמְנַצֵּחַ מִזְמוֹר לְדָוִד",
              style: textStyleSimpleText,
            ),
            TextSpan(
              text: endOfPasokStr,
      ...
      CustomRichTextPasok(
        ...
        textSpan: TextSpan(
          children: <TextSpan>[
            TextSpan(
              text:
                  "בְּיָדְךָ אַפְקִיד רוּחִי פָּדִיתָ אוֹתִי יְהוָה אֵל אֱמֶת",
              style: textStyleSimpleText,
            ),
            TextSpan(
              text: endOfPasokStr,
      ...
      CustomRichTextPasok(
        ...
        textSpan: TextSpan(
          children: <TextSpan>[
            TextSpan(
              text:
                  "שָׂנֵאתִי הַשֹּׁמְרִים הַבְלֵי שָׁוְא וַאֲנִי אֶל יְהוָה בָּטָחְתִּי",
              style: textStyleSimpleText,
            ),
            TextSpan(
              text: endOfPasokStr,
      ...
      CustomRichTextPasok(
        ...
        textSpan: TextSpan(
          children: <TextSpan>[
            TextSpan(
              text:
                  "מִכָּל צֹרְרַי הָיִיתִי חֶרְפָּה וְלִשְׁכֵנַי מְאֹד וּפַחַד לִמְיֻדָּעָי רֹאַי בַּחוּץ נָדְדוּ מִמֶּנִּי",
              style: textStyleSimpleText,
            ),
            TextSpan(
              text: endOfPasokStr,
